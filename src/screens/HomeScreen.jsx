...
const T = {
  th: {
    ...
    menus: [
      ...
      { emoji: '⚒️', label: 'ใบสั่งทำ',     sub: 'Work Order',     screen: 'WorkOrder',      col: '#550a19', bg: '#fdf0f2' },
  ...
  en: {
    ...
    menus: [
      ...
      { emoji: '⚒️', label: 'Work Order',     sub: 'ใบสั่งทำ',      screen: 'WorkOrder',      col: '#550a19', bg: '#fdf0f2' },
